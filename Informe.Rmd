...
ggplot(df, aes(y=round(error,2), x=modelos, col=datos)) +
        ...
        annotate("text",4.3,0.37,label="0.3995 Error en predicción con las seis mejores variables",size=1.9)
```
...
Este modelo es si se tiene en cuenta que al estimar el modelo con todas (60) las variables los indicadores son:
